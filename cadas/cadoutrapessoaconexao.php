...
define('DB_USERNAME', 'seu_usuario_bd'); // Seu nome de usuário do banco de dados (ex: root)
define('DB_PASSWORD', 'sua_senha_bd'); // Sua senha do banco de dados
define('DB_NAME', 'nome_do_seu_banco'); // O nome do seu banco de dados
